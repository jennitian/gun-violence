...
## Summary
The main goal of this part of the project was to compare the performances of different supervised machine learning algorithms on the same dataset. Given different features/targets the aim was to determine strengths and weaknesses. The four main types of algorithms used were logistic regression classifiers, linear SVMs, random forest classifiers, and finally neural networks. Each type of model was implemented for answering the first 3 framing questions and their performance metrics were compared. 
...
*see `models/` for algorithm code and in-depth summary*   
*see `results/` for model scores and interpretations*
